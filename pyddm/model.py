...
from .models.ic import ICPoint, ICPointRatio, ICPointSourceCenter, InitialCondition
...
class Model(object):
    ...
    def has_analytical_solution(self):
        ...
        if not issubclass(self.get_dependence("IC").__class__,(ICPoint,ICPointRatio,ICPointSourceCenter)):
            return False
